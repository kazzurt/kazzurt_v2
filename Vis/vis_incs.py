...
#         self.mainloop = 
    ...
    def inc(y):
        ...
        if fg>thresh_inc:
            ...
            p[0,np.random.randint(len(p[0,:]),size=3)] = rn.randint(150,255)
            p[1,np.random.randint(len(p[0,:]),size=3)] = rn.randint(150,255)
            p[2,np.random.randint(len(p[0,:]),size=3)] = rn.randint(150,255)
            cr+=1
            hg = 0
            hg2 +=1
        else:
