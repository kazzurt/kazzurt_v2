...
class scroll:
    ...
    def sweetscroll(y):
        global p, nn, ss3, tr1, qw, kz, mp, t1, cnt, t2, dT, cntp2, cntp3, sweetsc, s
        #I dont really like this one that much but I don't know what to do with it rn
        y = y**2
        gain.update(y)
        y /= gain.value
        y *= 255.0
