...
class energies:
    ...
    def energy_classic(y):
        #Pretty much the original from Naztronaut dude
    ...
    def energy_gaps(y):
        #This is pretty much energy classic overlapped with tic (or one of the tics)
        ...
        if ty>thresh:
            ...
            if qq>45:
                if qq<50:
                    thresh*=1.125
                    print("Threshold Change, energy_gaps")
                    print(thresh)     
                elif qq>100:
                    thresh*=.875
                    print("Threshold Change, energy_gaps")
