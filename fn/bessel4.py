...
#                     gre_ar[i,j] = (sp.jv(3,(i-20)*(j-12)/20+ (i-20)/5+(j-12)/5+tim/10)+.33)*255
            ...
            nu = 100
            for j in range(25):
                red_ar[:,j] = (sp.jv(3,(arx-xs)*(j-ys)**2/nu+ (arx-xs)/2 + (j-ys)/5  +tim/10+ph[0])+.33)
                blu_ar[:,j] = (sp.jv(3,(arx-xs)*(j-ys)**2/nu+ (arx-xs)/2+(j-ys)/5 +tim/10+ph[1])+.33)
                gre_ar[:,j] = (sp.jv(3,(arx-xs)*(j-ys)**2/nu+ (arx-xs)/2+(j-ys)/5 +tim/10+ph[2])+.33)
                    #gre_ar = sp.jv(1,j)
